...
func TestNewPageListFromJSON(t *testing.T) {
	pageList, err := blogger_tools_blogger.NewPageListFromJSON([]byte(pageListExampleJSON))
	if err != nil {
		t.Error(err)
		return
	}
  ...
  "items": [
    {
      ...
      "replies": {
        "totalItems": "0",
        "selfLink": "https://www.googleapis.com/blogger/v3/blogs/2399953/pages/7706273476706534553/comments"
      }
    },
    {
      "kind": "blogger#page",
